...
if ArteHackIsRunning == false then
	...
	function SetupSideBarButton(Text)
	...
	function SetupUI()
		...
		if Setuped == false then
			...
			script_settings.ButtonsFrame.BackgroundColor3 = Color3.new(56, 56, 56)
			...
			SetupSideBarButton("Visuals")
			SetupSideBarButton("Player")
	...
	local succes, err = pcall(function()
		...
		script_settings.HighLight["Door"] = true
		...
		task.spawn(function()
			while task.wait(0.1) do
				...
				for _, v in pairs(CurrentRooms:GetDescendants()) do
					if v.Name == "Door" and v.Parent.Parent.Parent == CurrentRooms then
